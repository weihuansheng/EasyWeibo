...
import com.microwei.easyweibo.model.net.FansListRequest;
 ...
 */
public class FansListFragmentPresenter extends AbsListFragmentPresenter<UserEntity>{
    private ListFragment<UserEntity> mListFragment;
    public FansListFragmentPresenter(ListFragment<UserEntity> listFragment){
